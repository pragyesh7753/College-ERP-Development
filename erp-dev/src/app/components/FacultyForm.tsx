...
export default function FacultyForm({ onClose }: FacultyFormProps): React.ReactElement {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>): void => {
    ...
    if (name.includes('.')) {
      ...
      setFormData(prev => {
        const sectionKey = section as keyof FacultyFormData;
        const sectionValue = prev[sectionKey];

        // Make sure the section is an object before spreading
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>, documentType: keyof Documents): void => {
